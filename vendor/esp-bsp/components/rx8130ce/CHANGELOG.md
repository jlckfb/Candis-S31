...
* Add raw register fallback accessors `rx8130ce_read_registers`/`rx8130ce_write_register`, restricted to the documented user registers (10h-23h, 30h) per appman 13.2.1 note *6; these cover the power-detection tuning fields (SMPTSEL/RSVSEL/BFVSEL) that have no structured API
