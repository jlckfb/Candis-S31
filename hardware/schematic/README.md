...
`SCH_Schematic_3_2026-08-10.pdf` is the current Candis-S31 EVT1 fabrication
schematic. `Easy-S31_SCH_v0.5_2026-07-28_0924.pdf` predates the fabrication
baseline and is retained only for history; its reference designators differ.
